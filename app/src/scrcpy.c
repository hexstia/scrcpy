...
SDL_bool scrcpy(const struct scrcpy_options *options) {
	//模拟用户传入的数据 scrcpy_options  options
    ...
    printf("device_socket: %d......\n",server.device_socket);
    printf("local_port: %d......\n",server.local_port);
    printf("tunnel_enabled: %d......\n",server.tunnel_enabled);
    printf("tunnel_forward: %d......\n",server.tunnel_forward);
    printf("server_copied_to_device: %d......\n",server.server_copied_to_device);
